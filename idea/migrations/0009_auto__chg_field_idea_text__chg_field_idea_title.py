...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'idea_idea', 'text', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True))

        # Changing field 'Idea.title'
        db.alter_column(u'idea_idea', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Idea.text'
        db.alter_column(u'idea_idea', 'text', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Idea.title'
        db.alter_column(u'idea_idea', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
