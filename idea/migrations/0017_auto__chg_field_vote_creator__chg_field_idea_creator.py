...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Vote.creator'
        db.alter_column(u'idea_vote', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Idea.creator'
        db.alter_column(u'idea_idea', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
