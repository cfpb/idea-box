...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Config', fields ['key']
        db.create_unique(u'idea_config', ['key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Config', fields ['key']
        db.delete_unique(u'idea_config', ['key'])
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 13, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
