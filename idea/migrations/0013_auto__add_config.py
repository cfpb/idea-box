...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'idea', ['Config'])


    def backwards(self, orm):
        # Deleting model 'Config'
        db.delete_table(u'idea_config')
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 30, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
