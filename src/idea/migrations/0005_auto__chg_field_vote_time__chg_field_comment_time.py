...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Vote.time'
        db.alter_column('idea_vote', 'time', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Comment.time'
        db.alter_column('idea_comment', 'time', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        'idea.comment': {
            ...
            'time': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 1, 0, 0)'})
        },
        'idea.idea': {
