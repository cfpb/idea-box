...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'idea_idea', 'summary', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Idea.summary'
        db.alter_column(u'idea_idea', 'summary', self.gf('django.db.models.fields.CharField')(max_length=250))
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 15, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
