...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'idea.idea': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
