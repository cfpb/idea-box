...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idea.summary'
        db.add_column(u'idea_idea', 'summary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)


        # Changing field 'Idea.text'
        db.alter_column(u'idea_idea', 'text', self.gf('django.db.models.fields.TextField')(default='', max_length=2000))

    def backwards(self, orm):
        # Deleting field 'Idea.summary'
        db.delete_column(u'idea_idea', 'summary')
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 3, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'idea.state': {
