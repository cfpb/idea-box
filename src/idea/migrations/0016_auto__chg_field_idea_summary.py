...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'idea_idea', 'summary', self.gf('django.db.models.fields.TextField')(max_length=200))
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 9, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
