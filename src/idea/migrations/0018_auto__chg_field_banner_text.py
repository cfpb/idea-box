...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'idea_banner', 'text', self.gf('django.db.models.fields.TextField')(max_length=2000))
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'text': ('django.db.models.fields.TextField', [], {'max_length': '2000'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 9, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
